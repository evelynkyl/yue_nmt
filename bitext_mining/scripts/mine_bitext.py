...
def bitext_mine(src_path, tgt_path): 
    ...
    sentences_written = 0
    with gzip.open('/mining_results/parallel-sentences-out.tsv.gz', 'wt', encoding='utf8') as fOut:
...
if __name__ == '__main__':
    bitext_mine(src_path="CW_zh_sents.txt", tgt_path="CW_yue_sents.txt")    
